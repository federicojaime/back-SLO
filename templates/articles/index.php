                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <?php if ($article['status'] === 'draft'): ?>
                                                    <li>
                                                        <a class="dropdown-item" href="/back-SLO/public/articles/publish/<?= $article['id'] ?>">
                                                            <i class="fas fa-globe me-2"></i>Publicar
                                                        </a>
                                                    </li>
                                                <?php elseif ($article['status'] === 'published'): ?>
                                                    <li>
                                                        <a class="dropdown-item" href="/back-SLO/public/articles/draft/<?= $article['id'] ?>">
                                                            <i class="fas fa-edit me-2"></i>Mover a borrador
                                                        </a>
                                                    </li>
                                                <?php endif; ?>
                                                ...
                                                <?php if ($article['status'] !== 'archived'): ?>
                                                    <li>
                                                        <a class="dropdown-item" href="/back-SLO/public/articles/archive/<?= $article['id'] ?>">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="/back-SLO/public/articles/feature/<?= $article['id'] ?>">
                                                        <i class="fas fa-star me-2"></i>
                                                        <?= ($article['featured'] ?? false) ? 'Quitar destacado' : 'Destacar' ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <hr class="dropdown-divider">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="metric-value" style="font-size: 24px;">
                        <?= count(array_filter($articles ?? [], function ($a) {
